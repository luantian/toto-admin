        ...
        <el-col :lg="16" :md="20" :sm="24" :xs="24">
          <el-form :model="form" status-icon ref="form" label-width="100px" @submit.native.prevent>
            ...
            <el-form-item label="出版社" prop="press">
              <el-input size="medium" v-model="form.press" placeholder="请填写图书出版社"></el-input>
            </el-form-item>
            <el-form-item label="价格" prop="price">
              <el-input size="medium" v-model="form.price" placeholder="请填写图书价格"></el-input>
            </el-form-item>
            <el-form-item label="isbn" prop="isbn">
              <el-input size="medium" v-model="form.isbn" placeholder="请填写图书isbn"></el-input>
            </el-form-item>
